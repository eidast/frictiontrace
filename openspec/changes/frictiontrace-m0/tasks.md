...
- [ ] 14.1 Bump version to `0.1.0` in all `package.json` files
- [ ] 14.2 Configure `npm publish` for the `engine` and `packages/cli` workspaces
- [ ] 14.3 Tag `v0.1.0` in git
- [ ] 14.4 Publish the package (or, if not ready to publish publicly, document the local install path in README)
